        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(originalPsw)){
                    ...
                    Toast.makeText(ModifyPswActivity.this,"输入的新密码和原始密码的不一致",Toast.LENGTH_SHORT).show();
                    return;

                }else if(MD5utils.md5(newPsw).equals(readPsw())){
                    Toast.makeText(ModifyPswActivity.this,"输入的新密码和原始密码的不能一致",Toast.LENGTH_SHORT).show();
                    return;
